...
public class connections_activity extends AppCompatActivity{
    /**
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                    ...
                    connections_activity.this.onConnectionInitiated(endpoint, connectionInfo);
                }
                    ...
                    if (!result.getStatus().isSuccess()) {
                        logW(
                                String.format(
                                        ...
                                        connections_activity.toString(result.getStatus())));
    ...
    FloatingActionButton start_button;
    FloatingActionButton participate_button;
    FloatingActionButton start_quiz_button;
    FloatingActionButton participate_quiz_button;
    TextView mText;
    View divider;
    TextView t1;
    TextView t2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        participate_button = findViewById(R.id.participate_button);
        start_quiz_button = findViewById(R.id.start_quiz_button);
        participate_quiz_button = findViewById(R.id.participate_quiz_button);
        mText = findViewById(R.id.disc_text);
        divider = findViewById(R.id.mid_divider);
        t1 = findViewById(R.id.textView2);
        t2 = findViewById(R.id.textView3);
        t3 = findViewById(R.id.textView2_quiz);
        t4 = findViewById(R.id.textView3_quiz);
    ...
    protected void onStart() {
        ...
        start_button.show();
        participate_button.show();
        start_quiz_button.show();
        participate_quiz_button.show();
